...
func deleteMovie(w http.ResponseWriter, req *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	params := mux.Vars(req) // value passed with request
...
func main() {
	...
	movies = append(movies, Movie{ID: "2", Isbn: "32553", Title: "Movie Two", Director: &Director{Firstname: "Steve", Lastname: "Smith"}})
